...
class Decoder(nn.Module):
    def __init__(self, num_features=1664, decoder_width = 1.0):
        ...
        self.up1 = UpSample_new(skip_input=features//1 + features//2, output_features=features//2)
        self.up2 = UpSample_new(skip_input=features//2 + features//2,  output_features=features//4)
        self.up3 = UpSample_new(skip_input=features//4 + features//4,  output_features=features//8)
        self.up4 = UpSample_new(skip_input=features//8 + features//8,  output_features=features//16)
